...
DEBUG = False
default_manifest = ".repo/manifests/narvis_default.xml"
custom_local_manifest = ".repo/local_manifests/narvis_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "narvis.dependencies"
org_manifest = "NARVIS-Devices"  # leave empty if org is provided in manifest
org_display = "NARVIS-Devices"  # needed for displaying
